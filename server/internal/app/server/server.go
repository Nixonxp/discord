...
import (
	...
	chat_svc "github.com/Nixonxp/discord/server/internal/app/services/chat"
	"github.com/Nixonxp/discord/server/pkg/servers"
	"sync"
	"time"
)
...
type MainServer struct {
	...
	chatSvcClient chat_svc.ChatClient
	servers       []Server
	cfg           *config.Config
}
