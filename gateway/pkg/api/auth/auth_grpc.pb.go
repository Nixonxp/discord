...
func (c *authServiceClient) OauthLoginCallback(ctx context.Context, in *OauthLoginCallbackRequest, opts ...grpc.CallOption) (*OauthLoginCallbackResponse, error) {
	out := new(OauthLoginCallbackResponse)
	err := c.cc.Invoke(ctx, AuthService_OauthLoginCallback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) OauthLoginCallback(context.Context, *OauthLoginCallbackRequest) (*OauthLoginCallbackResponse, error) {
...
func _AuthService_OauthLoginCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OauthLoginCallbackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).OauthLoginCallback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_OauthLoginCallback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).OauthLoginCallback(ctx, req.(*OauthLoginCallbackRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.Nixonxp.discord.auth.api.v1.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_OauthLoginCallback_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/app/api/auth/auth.proto",
}
